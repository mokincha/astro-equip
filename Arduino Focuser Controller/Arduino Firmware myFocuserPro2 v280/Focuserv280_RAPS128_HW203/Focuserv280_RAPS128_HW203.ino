// myfocuser RAPS128 FULL
// ONLY FOR USE RAPS128 Driver Board - supports 2A at 12VDC and 1/128 microstepping
// BIPOLAR STEPPER MOTORS ONLY
// SUPPORTS TEMPERATURE PROBE, LCD1602/I2C, PUSH BUTTONS, HOME POSITION SWITCH
...
#define myStep              4
#define myEnable            8
#define myM2                5             // for easydriver, do not connect
#define myM1                6             // for easydriver, connect to MS1
#define myM0                7             // for easydriver, connect to MS0
...
String programName = "myFP2.RAPS128HW203";
    ...
    case MED:
      switch ( myfocuser.stepmode )
      {
        ...
        case STEP32:
          ...
          break;
        case STEP64:
          motorSpeedDelay = MED64DELAY;
          break;
        case STEP128:
          motorSpeedDelay = MED128DELAY;
          break;
      }
      break;
    case FAST:
      switch ( myfocuser.stepmode )
      {
        ...
        case STEP32:
          ...
          break;
        case STEP64:
          motorSpeedDelay = FAST64DELAY;
          break;
        case STEP128:
          motorSpeedDelay = FAST128DELAY;
          break;
      }
      break;
  }
