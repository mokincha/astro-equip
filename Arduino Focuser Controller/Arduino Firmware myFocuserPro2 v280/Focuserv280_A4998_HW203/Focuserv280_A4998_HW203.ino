// myfocuser A4998_HW203
// ONLY FOR USE A4998 ONLY - supports 1A at 12VDC and microstepping
// BIPOLAR STEPPER MOTORS ONLY
// SUPPORTS PUSH BUTTONS, BUZZER, LEDS, TEMPERATURE PROBE, DISPLAY, HOME POSITION SWITCH
//
...
// myFocuser_A4998_MT_schem

// Stripboard/Layout
// myFocuser_hw203_A4988_MT_schem
// myFocuser_hw203_A4998_MT_Layout
...
// 2.73 test more changes to Push Button code
...
String programName = "myFP2.A4998HW203";
...
// A4998 supports Full, 1/2, 1/4 and 1/16 microstepping
...
{
  if (sensor1.getAddress(tpAddress, 0))   // look for probes, search the wire for address
  {
