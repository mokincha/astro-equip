// myfocuser example
// ONLY FOR USE WITH 28BYJ-48 AND ULN2003 DRIVER, FULL VERSION, SUPPORTS PUSH BUTTONS, SUPPORTS LCD, SUPPORTS TEMPERATURE PROBE
//
...
// SUPPORTS HOME POSITION SWITCH
// SUPPORTS BLUETOOTH
// SUPPORTS LCD DISPLAY

// CREATED FOR TERRY
// DO NOT USE WITH NORMAL ULN2003 - 28BYJ-28 STEPPER WHICH IS 4 PHASE MOTOR WITH STEP ANGLE OF 11.25° AND 2048 STEPS/REV
//
...
// http://www.instructables.com/id/BYJ48-Stepper-Motor/ by Mohannad Rawashdeh
//
...
const String programName = "ULN2003.8S";
...
#ifdef TEMPERATUREPROBE
// DS18B20 temperature probe info
OneWire oneWirech1(TEMPPIN);   // setup temperature probe 1
...
#endif
    (!myfocuser.ReverseDirection) ?  Direction = ANTICLOCKWISE :  Direction = CLOCKWISE;
...
#endif
    (!myfocuser.ReverseDirection) ?  Direction = CLOCKWISE :  Direction = ANTICLOCKWISE;
