...
// SUPPORT TEMPERATURE PROBE, LCD1602, PUSH BUTTONS
...
String programName = "myFP2.L293D";
...
#endif
    if ( myfocuser.stepmode == STEP2 )    // half step
...
void processCommand()
{
  ...
  switch ( cmdval )
  {
    ...
    case 11:  // :11#   Oxx#      Get coil pwr setting (00 = coils released after move, 01 = coil pwr on after move)
      replystr = "O" + String(myfocuser.coilpower) + "#";
      sendresponsestr(replystr);
      break;
    ...
    case 12:   // :12xx#      None    set coil pwr 0=release pwr after move, 1=keep power on after move
      ...
      myfocuser.coilpower = (byte) paramval & 0x01;
      flageepromupdate();
      break;
...
void setup()
{
  ...
  motorSpeedRPM = motorSpeedFastRPM;      // the motorspeed RPM setting
