...
// USES NEW LAYOUT TFTV2
//
// NO HOMEPOSITION SWITCH (not supported)
// ONLY TO BE USED WITH TFT 2.2" DISPLAY - ILI9341, TFT2.2 ILI9341 320x240
...
// PCB BOARDS
// Stripboard/Layout
// Focuserv250_DRV8825_TFT_2_2_F_schem
// myFocuser_DRV8825_TFT_2_2_F_Layout
// myFocuser_DRV8825_TFT_2_2_F_Subboard
...
#define DRV8825DIR          A4              // drv8825 control lines
#define DRV8825STEP         3
#define DRV8825ENABLE       A5
#define DRV8825M2           10              // for easydriver, do not connect
#define DRV8825M1           9               // for easydriver, connect to MS1
#define DRV8825M0           8               // for easydriver, connect to MS0
...
char tempString[12];
char programName[]    = "myFP2.DRV8825.TFT";
...
void displaylcd()
{
  ...
  {
    Tft.drawString(step4, 140, 120, TextSize, StepModeColor );
  }
  else if ( myfocuser.stepmode == 8 )
  {
    Tft.drawString(step8, 140, 120, TextSize, StepModeColor );
  }
  else if ( myfocuser.stepmode == 16 )
  {
    Tft.drawString(step16, 140, 120, TextSize, StepModeColor );
  }
  else if ( myfocuser.stepmode == 32 )
  {
    Tft.drawString(step32, 140, 120, TextSize, StepModeColor );
  }
...
void loop()
{
...
#ifdef TFTDISPLAY
    if ( myfocuser.lcdupdateonmove == 1 )    // check if lcd needs updating during move
    {
      updatecount++;
  ...
  else
  {
    ...
    if ( ((newdisplaytimestampNotMoving - olddisplaytimestampNotMoving) > (myfocuser.pagedisplaytime * 100)) || (newdisplaytimestampNotMoving < olddisplaytimestampNotMoving) )
    {
      ...
      displaylcd();                                     // update ALL the display values
    }
#endif
