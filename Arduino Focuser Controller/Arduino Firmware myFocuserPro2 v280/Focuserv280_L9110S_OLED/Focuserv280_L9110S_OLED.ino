// myFocuserPro2 L9110S Driver Board Full Option with OLED
...
// Stripboard/Layout
// myFocuser_L9110S_OLED_Layout_F
// my_focuser_L9110S_OLED_F_schem
...
char programName[]    = "myFP2.L9110S.OLED";
...
void setup()
{
  ...
  found = 0;
  datasize = sizeof( myfocuser );       // should be 32 bytes
