...
// SUPPORTS ROTARY ENCODER (uses Timer2)

// NO HOMEPOSITION SWITCH
...
// Mapping for Rotary Encoder - do not use with IR, pushbuttons or Bluetooth
...
// To enable rotary encoder, uncomment next line
...
const String programName = "myFP2.DRV8825.RE";
...
#ifdef BUZZER
    digitalWrite(BUZZERPIN, 1);                 // turn on buzzer
    delay( 250 );                               // beep for 100ms
    digitalWrite(BUZZERPIN, 0);                 // turn off buzzer
    delay( 100 );                               // delay between beeps for 50ms
#endif
  }
}
#endif
