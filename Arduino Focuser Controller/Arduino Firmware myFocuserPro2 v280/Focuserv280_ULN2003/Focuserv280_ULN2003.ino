// myfocuser ULN2003 - FULL STEP VERSION
// ONLY FOR USE WITH 28BYJ-48 AND ULN2003 DRIVER
// FULL VERSION
// SUPPORTS PUSH BUTTONS, LCD, TEMPERATURE PROBE, HOME POSITION SWITCH
//
// (c) Copyright Robert Brown 2014-2019. All Rights Reserved.

// THIS IS A HALF STEP VERSION FOR THE ULN2003 - PLEASE REPORT ANY ERRORS
...
// ----------------------------------------------------------------------------------------------------------
// PCB BOARDS
// ULN2003-M-MT-F-BT      https://aisler.net/p/DEYGMRQC

// Stripboard/Layout
// my_focuser_v200_ULN2003_Full
// my_focuser_v200_ULN2003_Full_schem
...
const String programName = "myFP2.ULN2003";
...
void settohome()                            // Switch is CLOSED
{
  ...
  if ( stepperpower == 1)
  {
    ...
    while (hpswstate == HPSWCLOSED )
    {
      ...
      stepstaken++;
      delayMicroseconds(SLOWDELAY1);        // small delay
...
void loop()
{
  ...
  stepperpowerread = analogRead( STEPPERDETECTPIN );
  (stepperpowerread > 800) ? stepperpower = 1 : stepperpower = 0;
  // for ULN2003 which is powered from 9V, the reading is 840
#endif
