// myfocuser L293DMINI FULL
// ONLY FOR USE L293D MINI DRIVER BOARD AND ARDUINO NANO
// FULL VERSION - SUPPORTS PUSH BUTTONS, NOKIA LCD, TEMPERATURE PROBE
//
...
String programName = "myFP2.L293DMINI.NOKIA";
...
void processCommand()
{
  ...
  switch ( cmdval )
  {
    ...
    case 36:
      ...
      // there is no way to turn off display
      break;
...
void setup()
{
  ...
  // ensure validated values are saved
  writenow = 1;
