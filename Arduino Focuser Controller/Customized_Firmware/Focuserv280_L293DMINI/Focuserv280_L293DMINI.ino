...
// FULL VERSION - SUPPORTS PUSH BUTTONS, LCD, TEMPERATURE PROBE, HOME POSITION SWITCH
//
...
// PCB BOARDS
// PCB to use
// L293DMINI-M-MT-F-BT   https://aisler.net/p/OHCTYHDU (not TFT)

// Stripboard/Layout
// my_focuser_L293DMINI_F_schem
// myFocuser_L293DMINI_Layout_F
...
// To use an OLED display, uncomment the next line
...
String programName = "myFP2.L293DMINI";
...
#ifdef LCDDISPLAY
#ifdef OLEDDISPLAY
#halt // ERROR - You cannot have both the OLED and LCD Display at same time, use one or the other
#endif
#endif
...
void loop()
{
  ...
  else
  {
    ...
    // see if the display needs updating
    long currentMillis = millis();
    if ( ((currentMillis - olddisplaytimestampNotMoving) > myfocuser.pagedisplaytime) || (currentMillis < olddisplaytimestampNotMoving) )
    {
      olddisplaytimestampNotMoving = currentMillis;    // update the timestamp
