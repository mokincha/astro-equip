...
namespace ASCOM.PV_10pos
{
    ...
    public class FilterWheel : IFilterWheelV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.PV_10pos.FilterWheel";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM FilterWheel Driver for PV_10pos.";
        ...
        private string[] fwNames = new string[10] { "Open", "Dark", "All Pass", "Red", "Green",
                                                    "Blue", "LPF", "Grating", "Moon ND", "Aux1" }; //class level variable to hold the filter names
