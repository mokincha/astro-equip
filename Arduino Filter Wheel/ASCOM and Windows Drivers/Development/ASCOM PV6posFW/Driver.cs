...
//
// ASCOM FilterWheel driver for PV_10pos
//
...
namespace ASCOM.PV_6pos
{
    //
    // Your driver's DeviceID is ASCOM.PV_10pos.FilterWheel
    //
    // The Guid attribute sets the CLSID for ASCOM.PV_10pos.FilterWheel
    // The ClassInterface/None addribute prevents an empty interface called
    // _PV_10pos from being created and used as the [default] interface
    //
    ...
    /// ASCOM FilterWheel Driver for PV_10pos.
    /// </summary>
    [Guid("ea4f051d-7b41-432a-9c2f-ce9fc2371420")]
    ...
    public class FilterWheel : IFilterWheelV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.PV_6pos.FilterWheel";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM FilterWheel Driver for PV_6pos.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PV_10pos"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public FilterWheel()
        {
            tl = new TraceLogger("", "PV_6pos");
        ...
        private int[] fwOffsets = new int[6] { 0, 0, 0, 0, 0, 0 }; //class level variable to hold focus offsets
        private string[] fwNames = new string[6] { "Open", "Dark", "All Pass", "Red", "Green", "Blue" }; //class level variable to hold the filter names
