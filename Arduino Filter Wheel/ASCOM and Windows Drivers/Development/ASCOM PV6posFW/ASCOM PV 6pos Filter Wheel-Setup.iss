...
#define BaseCodePath = "C:\Temp"

#define DefaultCodeFolder="ASCOM PV6posFW"

#define AppName="ASCOM PV 6pos Filter Wheel"

[Setup]
AppId={{772C520C-2C45-4A9C-82B3-922D9E7420DD}
AppName={#AppName}
...
UninstallDisplayIcon="{app}\ASCOM.PV_6pos.FilterWheel.dll"
...
[Files]
Source: "{#BaseCodePath}\Development\{#DefaultCodeFolder}\bin\{#ReleaseType}\ASCOM.PV_6pos.FilterWheel.dll"; DestDir: "{app}"
Source: "{#BaseCodePath}\Development\{#DefaultCodeFolder}\VersionHistory.txt"; DestDir: "{app}" ;Flags: isreadme

[Icons]
Name: "{commondesktop}\{#DefaultCodeFolder}"; Filename: "{app}\ASCOM.PV_6pos.FilterWheel.dll"

; Only if driver is .NET
[Run]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PV_6pos.FilterWheel.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PV_6pos.FilterWheel.dll"""; Flags: runhidden 64bit; Check: IsWin64

; Only if driver is .NET
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PV_6pos.FilterWheel.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PV_6pos.FilterWheel.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PV_6pos.FilterWheel.dll"""; Flags: runhidden 64bit; Check: IsWin64
