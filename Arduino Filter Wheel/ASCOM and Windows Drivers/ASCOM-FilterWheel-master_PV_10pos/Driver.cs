...
namespace ASCOM.QuidneArduino
{
    ...
    [Guid("195f2a76-f2e5-49a5-a74a-31dead5291bb")]
    ...
    public class FilterWheel : IFilterWheelV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.PV.FilterWheel10";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM 10 Pos PV FilterWheel Driver.";
        ...
        private string[] fwNames = new string[ 10 ] { "Open", "Dark", "All Pass", "Red", "Green", "Blue",
                                                        "LPF", "Grating", "ND", "Aux1" }; //class level variable to hold the filter names
