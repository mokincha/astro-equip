...
#define	NORMAL_ACCELERATION					60000
#define	POSITION_SEEK_STEP_SIZE_IN_STEPS	( MICROSTEPS_PER_REVOLUTION / 360 )

#define	HOME_ACCELERATION					60000
#define HOME_SEARCH_SPEED_FAST  			6000
#define HOME_SEARCH_SPEED_SLOW  			500
#define HOME_SEEK_STEP_SIZE_IN_STEPS  		( 1.0f * MICROSTEPS_PER_REVOLUTION / 360 )
