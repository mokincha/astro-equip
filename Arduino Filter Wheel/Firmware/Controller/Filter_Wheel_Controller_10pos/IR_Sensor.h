...
#define	IRS_HOME_THRESHOLD_FACTOR					( 0.5f )
#define	IRS_POSITION_THRESHOLD_FACTOR				( 0.5f )

#define SENSOR_HOME_ADAPTIVE_THRESHOLD_MAX_DIFF				700		// the global min/max difference has to be within this distance from the defaults to be considered valid
#define SENSOR_HOME_ADAPTIVE_THRESHOLD_MIN_DIFF				500		// the global min/max difference has to be at least this distance from the defaults to be considered valid
																	//
#define SENSOR_POSITION_ADAPTIVE_THRESHOLD_MAX_DIFF			775		// the global min/max difference has to be within this distance from the defaults to be considered valid
#define SENSOR_POSITION_ADAPTIVE_THRESHOLD_MIN_DIFF			500		// the global min/max difference has to be at least this distance from the defaults to be considered valid
